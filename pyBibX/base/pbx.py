...
class pbx_probe():
    def __init__(self, file_bib, db = 'scopus', del_duplicated = True):
        ...
        self.country_alpha_2 = constants.country_alpha_2
        self.country_alpha_3 = constants.country_alpha_3
        self.country_numeric = constants.country_numeric
        self.country_lat_long = constants.country_lat_long
